          ...
          <tr>
            ...
            {Children.map(children, (child, key) => {
              ...
              if (child.type.name === Column.name) {
                const { title, className, sortKey, style, typeColumn, filterName, filterOption } = child.props;
                    ...
                    <div className={`flex items-center ${Sort[sortKey]} item-hover component-container`}>
                      ...
                      {!!sortKey && (
                        <>
                          ...
                          <ToggleVisibility onReset={onResetColum} column={sortKey} title={title} typeColumn={typeColumn} filterName={filterName} filterOption={filterOption}>
                            </ToggleVisibility>
                          </span>
                        </>
                      )}
