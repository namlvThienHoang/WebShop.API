...
export function confirm(message: string, onConfirm: { (): Promise<void>; (): Promise<void>; (): Promise<void>; (): Promise<void>; (): Promise<void>; (): Promise<void>; }) {
  confirmationSubject.next({ message, onConfirm });
}
          ...
          <div className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full justify-center items-start flex">
            <div className="relative w-full max-w-md max-h-full">
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                >
                  <HiX className="w-5 h-5" viewBox="0 0 20 20" />
                </button>
